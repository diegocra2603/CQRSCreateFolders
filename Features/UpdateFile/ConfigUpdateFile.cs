...
namespace CQRSCreateFolders.Features.UpdateFile;

public class ConfigUpdateFile
{
    private readonly string _nameFile;
    private readonly string _fileNamespace;
    public ConfigUpdateFile(string nameFile, string fileNamespace)
    {
        _nameFile = nameFile;
    ...
    public Handler GetHandler(){
        ...
        handler.NameSpace = $"{_fileNamespace}.Update";

        handler.Name = $"Update{_nameFile}Command";
    ...
    public Command GetCommand(){
        ...
        command.NameSpace = $"{_fileNamespace}.Update";
        command.Name = $"Update{_nameFile}Command";
    ...
    public Validator GetValidator(){
        ...
        validator.NameSpace = $"{_fileNamespace}.Update";
        validator.Name = $"Update{_nameFile}Command";
        validator.Content = """
